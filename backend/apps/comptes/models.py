...
# Mots à consonance sénégalaise (CLAUDE.md : contenu sénégalais uniquement),
...
def generer_pseudonyme():
    ...
    l'anonymat du forum (CLAUDE.md section 8).
    """
    while True:
...
class Utilisateur(CompteUtilisateur):
    ...
    # Utilisé par le forum à la place de nom/prenom/email (CLAUDE.md section 8).
